                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            if (_model.emailTextController.text != '') {
                              await UserGroup.forgetPasswordOTPCall.call(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.apiResultsxa =
                                await AuthenticationGroup.signInCall.call(
                              email: _model.emailTextController.text,
                            ...
                            shouldSetState = true;
                            if ((_model.apiResultsxa?.succeeded ?? true)) {
                              ...
                              FFAppState().Token = getJsonField(
                                (_model.apiResultsxa?.jsonBody ?? ''),
                                r'''$.token''',
                              ).toString();
                              safeSetState(() {});
                              if (UserGroup.userDataCall.userisDelete(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () async {
                                context.pushNamed('RegisterSupplier');
                              },
                          )
                        ],
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
