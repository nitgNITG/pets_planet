...
import 'pet_detalis_model.dart';
export 'pet_detalis_model.dart';

class PetDetalisWidget extends StatefulWidget {
  const PetDetalisWidget({
    super.key,
    required this.petId,
    this.petswithdiscount,
  });

  final int? petId;
  final double? petswithdiscount;

  @override
  State<PetDetalisWidget> createState() => _PetDetalisWidgetState();
}

class _PetDetalisWidgetState extends State<PetDetalisWidget> {
  late PetDetalisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetDetalisModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final petDetalisFetchOnlyPetResponse = snapshot.data!;
                                      ...
                                      Text(
                                        getJsonField(
                                          HomeGroup.fetchOnlyPetCall.petList(
                                            petDetalisFetchOnlyPetResponse
                                                .jsonBody,
                                          ),
                                          r'''$.name''',
                                        ).toString(),
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    getJsonField(
                                      HomeGroup.fetchOnlyPetCall.petList(
                                        petDetalisFetchOnlyPetResponse.jsonBody,
                                      ),
                                      r'''$.images[:].url''',
                                    ).toString(),
                                    width: 200.0,
                                      ...
                                      child: FutureBuilder<ApiCallResponse>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              _model.api2 = await FavouriteGroup
                                                  .favUpdatePetsCall
                                                  .call(
                                                petId: widget.petId,
                                                token: FFAppState().Token,
