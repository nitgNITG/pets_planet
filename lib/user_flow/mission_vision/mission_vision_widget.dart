  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final missionVisionAboutAppResponse = snapshot.data!;
                              ...
                              children: [
                                if (FFLocalizations.of(context).languageCode ==
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                      'Mission: ${getJsonField(
                                        missionVisionAboutAppResponse.jsonBody,
                                        r'''$.aboutApp.mission''',
                                      ).toString()}Vision: ${getJsonField(
                                        missionVisionAboutAppResponse.jsonBody,
                                        r'''$.aboutApp.vission''',
                                      ).toString()}',
                                ...
                                if (FFLocalizations.of(context).languageCode ==
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                      'مهمة:${getJsonField(
                                        missionVisionAboutAppResponse.jsonBody,
                                        r'''$.aboutApp.missionar''',
                                      ).toString()}رؤية:${getJsonField(
                                        missionVisionAboutAppResponse.jsonBody,
                                        r'''$.aboutApp.vissionar''',
                                      ).toString()}',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
