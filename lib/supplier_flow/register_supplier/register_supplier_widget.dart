...
import 'register_supplier_model.dart';
export 'register_supplier_model.dart';

class RegisterSupplierWidget extends StatefulWidget {
  const RegisterSupplierWidget({super.key});

  @override
  State<RegisterSupplierWidget> createState() => _RegisterSupplierWidgetState();
}

class _RegisterSupplierWidgetState extends State<RegisterSupplierWidget> {
  late RegisterSupplierModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterSupplierModel());
                              ...
                              children: [
                                TextSpan(
                                  text: FFLocalizations.of(context).getText(
                                    '5zqs0h5q' /* By  Signing Up, You Agree To
  */
                                    ,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'lud1x56w' /* Already Have An Account ? */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                          ...
                          onPressed: () async {
                            ...
                            if (_model.checkboxValue == true) {
                              if (_model.passwordTextController.text ==
                                ...
                                _model.apiResultzbh = await AuthenticationGroup
                                ...
                                if ((_model.apiResultzbh?.succeeded ?? true)) {
                                  FFAppState().Token = AuthenticationGroup
                                      .signUpSupplierFirstCall
                                      .token(
                                    (_model.apiResultzbh?.jsonBody ?? ''),
                                  )!;
                                  FFAppState().SupId = currentUserUid;
                                  safeSetState(() {});
