  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final addPetFetchSpeciesResponse = snapshot.data!;
                    ...
                    children: [
                          ...
                          child: FlutterFlowDropDown<int>(
                            controller: _model.dropDownValueController ??=
                              ...
                              _model.dropDownValue ??=
                                  HomeGroup.fetchSpeciesCall
                                      .speciesid(
                                        addPetFetchSpeciesResponse.jsonBody,
                                      )
                                      ?.first,
                            ),
                            options: List<int>.from(
                                HomeGroup.fetchSpeciesCall.speciesid(
                              addPetFetchSpeciesResponse.jsonBody,
                            )!),
                            optionLabels:
                                HomeGroup.fetchSpeciesCall.speciesname(
                              addPetFetchSpeciesResponse.jsonBody,
                            )!,
                            onChanged: (val) =>
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: SupplierGroup.addPetCall.call(
                            lang: FFAppState().lang,
                          ...
                          builder: (context, snapshot) {
                            ...
                            final buttonAddPetResponse = snapshot.data!;
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.apiResultste =
                                    await SupplierGroup.addPetCall.call(
                                  ...
                                  speciesId: _model.dropDownValue,
                                  descreption:
                                  ...
                                  disscount: _model.checkboxValue == true
                                      ...
                                      : 0,
                                  startdate: _model.checkboxValue == true
                                      ? _model.datePicked1?.toString()
                                      : '0',
                                  enddate: _model.checkboxValue == true
