...
class _EditPetsWidgetState extends State<EditPetsWidget> {
  ...
  void initState() {
    ...
    _model.stockTextController1 ??=
        TextEditingController(text: widget.stock?.toString());
    _model.stockFocusNode1 ??= FocusNode();

    _model.stockTextController2 ??=
        TextEditingController(text: widget.age?.toString());
    _model.stockFocusNode2 ??= FocusNode();

    _model.discountTextController ??= TextEditingController(
        text: widget.discount != null ? widget.discount?.toString() : '0');
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final editPetsFetchSpeciesResponse = snapshot.data!;
                        ...
                        child: Container(
                          ...
                          child: FlutterFlowDropDown<int>(
                            controller: _model.dropDownValueController ??=
                              ...
                              _model.dropDownValue ??=
                                  HomeGroup.fetchSpeciesCall
                                      .speciesid(
                                        editPetsFetchSpeciesResponse.jsonBody,
                                      )
                            ...
                            onChanged: (val) async {
                              ...
                              FFAppState().PetsId = _model.dropDownValue!;
                              safeSetState(() {});
                            },
                            width: 200.0,
                            height: 55.0,
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              width: double.infinity,
                              child: TextFormField(
                                controller: _model.stockTextController1,
                                focusNode: _model.stockFocusNode1,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model.stockTextController1Validator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              width: double.infinity,
                              child: TextFormField(
                                controller: _model.stockTextController2,
                                focusNode: _model.stockFocusNode2,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model.stockTextController2Validator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.apiResultste =
                                    await SupplierGroup.editPetCall.call(
                                  id: widget.proId,
                                  ...
                                  endDate: _model.datePicked2 != null
                                      ...
                                      : widget.endtDate,
                                  age: int.tryParse(
                                      _model.stockTextController2.text),
                                  lang: FFAppState().lang,
                                  token: FFAppState().Token,
                                );
