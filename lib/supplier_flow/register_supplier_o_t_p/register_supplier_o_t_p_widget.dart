...
import 'register_supplier_o_t_p_model.dart';
export 'register_supplier_o_t_p_model.dart';

class RegisterSupplierOTPWidget extends StatefulWidget {
  const RegisterSupplierOTPWidget({
    super.key,
    this.email,
  });
  ...
  @override
  State<RegisterSupplierOTPWidget> createState() =>
      _RegisterSupplierOTPWidgetState();
}

class _RegisterSupplierOTPWidgetState extends State<RegisterSupplierOTPWidget> {
  late RegisterSupplierOTPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterSupplierOTPModel());
                        ...
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'it1naotd' /* Please enter the verification ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'uolurdxb' /* Resend Will Be Avaliable In  */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Inter',
